...
export const SetTestStatusBooked = createAction('[JournalEffects] Set Test Status to Booked', (slotId: string) => ({
	slotId,
}));

export const SetTestStatusStarted = createAction('[JournalEffects] Set Test Status to Started', (slotId: string) => ({
	slotId,
}));

export const SetTestStatusDecided = createAction('[JournalEffects] Set Test Status to Decided', (slotId: string) => ({
	slotId,
}));

export const SetTestStatusWriteUp = createAction('[JournalEffects] Set Test Status to WriteUp', (slotId: string) => ({
	slotId,
}));
