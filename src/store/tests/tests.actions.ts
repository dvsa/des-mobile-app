...
export const SendCompletedTests = createAction('[TestsEffects] Send Completed Tests');
...
export const SendCurrentTest = createAction('[TestsEffects] Send Current Test');

export const SendCurrentTestSuccess = createAction('[Tests] Send Test Success');

export const SendCompletedNoneSent = createAction('[Tests] No completed tests sent');
