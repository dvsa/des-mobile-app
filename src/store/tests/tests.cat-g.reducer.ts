...
import { testDataCatGReducer } from '@store/tests/test-data/cat-home/test-data.cat-g.reducer';
...
export function testsCatGReducer(action: Action, state: CatGUniqueTypes.TestResult)
