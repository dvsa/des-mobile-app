...
export const testSummaryMod2Reducer = createReducer(
  ...
  on(
    fromTestSummaryActions.RouteNumberChanged,
    (state, { routeNumber }): TestSummary => ({
      ...state,
  ...
  on(
    fromTestSummaryActions.IndependentDrivingTypeChanged,
    (state, { independentDriving }): TestSummary => ({
      ...state,
      independentDriving,
    })
  ),
  ...
  on(
    fromMod2fromTestSummaryActions.ModeOfTransportChanged,
    (state, { modeOfTransport }): TestSummary => ({
      ...state,
      modeOfTransport,
    })
  )
