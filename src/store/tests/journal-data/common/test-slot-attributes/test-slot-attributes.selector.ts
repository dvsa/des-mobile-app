...
export const selectTestTime = createSelector(selectTestSlotAttributes, (testSlotAttributes) =>
  moment(testSlotAttributes.start).format('HH:mm')
);

export const selectTestDate = createSelector(selectTestSlotAttributes, (testSlotAttributes) =>
  moment(testSlotAttributes.start).format('DD/MM/YYYY')
);
...
export const selectSlotId = createSelector(selectTestSlotAttributes, (testSlotAttributes) => testSlotAttributes.slotId);
