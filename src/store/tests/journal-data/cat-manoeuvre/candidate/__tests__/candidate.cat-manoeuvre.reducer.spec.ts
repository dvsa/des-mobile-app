import { candidateCatManoeuvreReducer } from '@store/tests/journal-data/cat-manoeuvre/candidate/candidate.cat-manoeuvre.reducer';
  ...
  describe('PassCertificateNumberChanged', () => {
    it('should toggle the value passed when called', () => {
      const result = candidateCatManoeuvreReducer(
        { candidateId: 1 },
        candidateActions.PopulateCandidateDetailsCatManoeuvre({ candidateId: 2 })
      );
