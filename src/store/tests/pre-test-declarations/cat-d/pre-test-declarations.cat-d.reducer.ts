...
export const preTestDeclarationsCatDReducer = createReducer(
	...
	on(
		...
		(state): CatDUniqueTypes.PreTestDeclarations => ({
			...state,
	...
	on(
		...
		(state, { signature }): CatDUniqueTypes.PreTestDeclarations => ({
			...state,
	...
	on(
		...
		(state, { declarationStatus }): CatDUniqueTypes.PreTestDeclarations => ({
			...state,
	...
	on(
		...
		(state, { manoeuvrePassCertificateNumber }): CatDUniqueTypes.PreTestDeclarations => ({
			...state,
