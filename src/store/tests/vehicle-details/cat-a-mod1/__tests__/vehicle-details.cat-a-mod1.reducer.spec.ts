...
describe('vehicleDetailsCatAMod1Reducer', () => {
  ...
  describe('MotStatusChanged', () => {
    it('should set motStatus to the value given', () => {
      const result = vehicleDetailsCatAMod1Reducer({ motStatus: null }, vehicleDetailsActions.MotStatusChanged('test'));
  ...
  describe('PopulateVehicleDimensions', () => {
    it('should toggle schoolBike', () => {
      const result = vehicleDetailsCatAMod1Reducer({ schoolBike: true }, vehicleDetailsActions.SchoolBikeToggled());
