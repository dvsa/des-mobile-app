...
import { selectCommunicationPreference } from '@store/tests/communication-preferences/communication-preferences.reducer';
...
export const selectCommunicationPreferenceUpdatedEmail = createSelector(selectCommunicationPreference, (pref) =>
  get(pref, 'updatedEmail', '')
);
...
export const selectCommunicationPreferenceType = createSelector(selectCommunicationPreference, (pref) =>
  get(pref, 'communicationMethod', '')
);
