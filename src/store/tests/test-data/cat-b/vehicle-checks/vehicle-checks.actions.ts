...
export const TellMeQuestionCorrect = createAction('[Vehicle Checks] Tell me question correct');

export const TellMeQuestionDrivingFault = createAction('[Vehicle Checks] Tell me question driving fault');
...
export const ShowMeQuestionPassed = createAction('[Vehicle Checks] Show me question passed');

export const ShowMeQuestionDrivingFault = createAction('[Vehicle Checks] Show me question driving fault');

export const ShowMeQuestionSeriousFault = createAction('[Vehicle Checks] Show me question serious fault');

export const ShowMeQuestionDangerousFault = createAction('[Vehicle Checks] Show me question dangerous fault');
