...
export const vehicleChecksCatDReducer = createReducer(
  initialState,
  on(
    vehicleChecksCatDActionTypes.InitializeVehicleChecks,
    (): CatDUniqueTypes.VehicleChecks => ({
      ...generateInitialState(),
    })
  ),
  on(
    vehicleChecksCatDActionTypes.ShowMeQuestionOutcomeChanged,
    (state, { showMeQuestionOutcome, index }): CatDUniqueTypes.VehicleChecks => ({
      ...state,
  ...
  on(
    vehicleChecksCatDActionTypes.ShowMeQuestionSelected,
    (state, { showMeQuestion, index }): CatDUniqueTypes.VehicleChecks => ({
      ...state,
      showMeQuestions: state.showMeQuestions.map((item, itemIndex) => (index === itemIndex ? showMeQuestion : item)),
    })
  ),
  on(
    vehicleChecksCatDActionTypes.TellMeQuestionSelected,
    (state, { tellMeQuestion, index }): CatDUniqueTypes.VehicleChecks => ({
      ...state,
      tellMeQuestions: state.tellMeQuestions.map((item, itemIndex) => (index === itemIndex ? tellMeQuestion : item)),
    })
  ),
  on(
    vehicleChecksCatDActionTypes.TellMeQuestionOutcomeChanged,
    (state, { tellMeQuestionOutcome, index }): CatDUniqueTypes.VehicleChecks => ({
      ...state,
  ...
  on(
    vehicleChecksCatDActionTypes.AddShowMeTellMeComment,
    (state, { comment }): CatDUniqueTypes.VehicleChecks => ({
      ...state,
      showMeTellMeComments: comment,
    })
  ),
  on(
    vehicleChecksCatDActionTypes.VehicleChecksCompletedToggled,
    (state, { toggled }): CatDUniqueTypes.VehicleChecks => ({
      ...state,
      vehicleChecksCompleted: toggled,
    })
  ),
  on(
    vehicleChecksCatDActionTypes.VehicleChecksDrivingFaultsNumberChanged,
    (state, { payload }): CatDUniqueTypes.VehicleChecks => ({
      ...state,
      showMeQuestions: [...payload],
    })
  ),
  on(
    vehicleChecksCatDActionTypes.DropExtraVehicleChecks,
  ...
  on(
    vehicleChecksCatDActionTypes.SetFullLicenceHeld,
    (state, { fullLicenceHeld }): CatDUniqueTypes.VehicleChecks => ({
      ...state,
      fullLicenceHeld,
    })
  )
