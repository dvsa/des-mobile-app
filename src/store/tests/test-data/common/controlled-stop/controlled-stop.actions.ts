...
export const ToggleControlledStop = createAction('[ControlledStop] Toggle Controlled Stop');

export const ControlledStopAddDrivingFault = createAction('[ControlledStop] Add Driving Fault');

export const ControlledStopAddSeriousFault = createAction('[ControlledStop] Add Serious Fault');
