...
describe('lessonAndThemeReducer', () => {
  describe('StudentLevelChanged', () => {
    it(
      'should set student level to the value passed when called if' +
        ' it is not the same as the current student level',
      () => {
        const result = lessonAndThemeReducer(
          { studentLevel: 'trained' },
          lessonAndThemeActions.StudentLevelChanged('partlyTrained')
        );
        expect(result).toEqual({ studentLevel: 'partlyTrained' });
      }
    );
    it(
      'should set student level to null when called if' + ' the value passed is the same as the current student level',
      () => {
        const result = lessonAndThemeReducer(
          { studentLevel: 'trained' },
          lessonAndThemeActions.StudentLevelChanged('trained')
        );
  ...
  describe('LessonThemeChanged', () => {
    it('should append lessonThemes with the value passed when called' + ' if it is not already included', () => {
      const result = lessonAndThemeReducer(
        { lessonThemes: ['ecoSafeDriving'] },
    ...
    it('should remove the value passed from lessonThemes when called' + ' if it is already included', () => {
      const result = lessonAndThemeReducer(
  ...
  describe('OtherChanged', () => {
    it('should set other to the value passed when called', () => {
      const result = lessonAndThemeReducer({ other: null }, lessonAndThemeActions.OtherChanged('test'));
