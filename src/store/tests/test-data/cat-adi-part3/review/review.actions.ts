...
export const ImmediateDangerChanged = createAction('[Review] Immediate danger changed', (immediateDanger: boolean) => ({
	immediateDanger,
}));
...
export const FeedbackChanged = createAction('[Review] Feedback changed', (feedback: string) => ({ feedback }));
...
export const GradeChanged = createAction('[Review] Grade changed', (grade: string) => ({ grade }));
