...
export const VehicleChecksCompletedToggle = createAction('[Vehicle Checks] [CatADI2] Vehicle Checks Completed Toggled');
...
export const VehicleChecksAddSeriousFault = createAction('[Vehicle Checks] [CatADI2] Vehicle Checks Add Serious Fault');
