...
describe('Vehicle Checks Cat ADI2 Reducer', () => {
	...
	describe('VehicleChecksAddSeriousFault', () => {
		it('should set seriousFault to true', () => {
			const result = vehicleChecksCatADI2Reducer({}, vehicleChecksCatADI2ActionTypes.VehicleChecksAddSeriousFault());
	...
	describe('VehicleChecksAddDangerousFault', () => {
		it('should set dangerousFault to true', () => {
			const result = vehicleChecksCatADI2Reducer({}, vehicleChecksCatADI2ActionTypes.VehicleChecksAddDangerousFault());
	...
	describe('VehicleChecksRemoveSeriousFault', () => {
		it('should set seriousFault to false', () => {
			const result = vehicleChecksCatADI2Reducer({}, vehicleChecksCatADI2ActionTypes.VehicleChecksRemoveSeriousFault());
	...
	describe('VehicleChecksCompletedToggle', () => {
		it('should toggle vehicleChecksCompleted', () => {
			...
			result = vehicleChecksCatADI2Reducer(result, vehicleChecksCatADI2ActionTypes.VehicleChecksCompletedToggle());
