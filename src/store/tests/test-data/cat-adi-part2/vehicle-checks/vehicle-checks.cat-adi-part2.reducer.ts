...
export const vehicleChecksCatADI2Reducer = createReducer(
	initialState,
	on(
		vehicleChecksCatADI2ActionTypes.ShowMeQuestionSelected,
		(state, { showMeQuestion, index }): CatADI2UniqueTypes.VehicleChecks => ({
			...state,
	...
	on(
		vehicleChecksCatADI2ActionTypes.TellMeQuestionSelected,
		(state, { tellMeQuestion, index }): CatADI2UniqueTypes.VehicleChecks => ({
			...state,
			tellMeQuestions: state.tellMeQuestions.map((item, i) => (i === index ? tellMeQuestion : item)),
		})
	),
	on(
		vehicleChecksCatADI2ActionTypes.TellMeQuestionOutcomeChanged,
		(state, { tellMeQuestionOutcome, index }): CatADI2UniqueTypes.VehicleChecks => ({
			...state,
	...
	on(
		vehicleChecksCatADI2ActionTypes.AddShowMeTellMeComment,
		(state, { payload }): CatADI2UniqueTypes.VehicleChecks => ({
			...state,
			showMeTellMeComments: payload,
		})
	),
	on(
		vehicleChecksCatADI2ActionTypes.ShowMeQuestionAddDrivingFault,
		(state, { payload }): CatADI2UniqueTypes.VehicleChecks => ({
			...state,
			showMeQuestions: state.showMeQuestions.map((item, i) =>
				i === payload
	...
	on(
		vehicleChecksCatADI2ActionTypes.ShowMeQuestionRemoveDrivingFault,
		(state, { payload }): CatADI2UniqueTypes.VehicleChecks => ({
			...state,
			showMeQuestions: state.showMeQuestions.map((item, i) =>
				i === payload
	...
	on(
		vehicleChecksCatADI2ActionTypes.VehicleChecksCompletedToggle,
		(state): CatADI2UniqueTypes.VehicleChecks => ({
			...state,
