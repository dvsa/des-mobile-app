...
describe('Test Requirements CAT C Reducer', () => {
  describe('TOGGLE_LEGAL_REQUIREMENT', () => {
    it('should toggle uphill start to complete(true) when dispatched first time', () => {
      ...
      const result = testRequirementsCatCReducer(state, ToggleLegalRequirement(LegalRequirements.uphillStart));
    ...
    it('should toggle uphill start to incomplete(false) when dispatched second time', () => {
      const state: TestRequirements = {};
      const modifiedState = testRequirementsCatCReducer(state, ToggleLegalRequirement(LegalRequirements.uphillStart));
      const result = testRequirementsCatCReducer(modifiedState, ToggleLegalRequirement(LegalRequirements.uphillStart));
