...
@Component({
  selector: 'safety-questions-cat-a-mod2',
  templateUrl: 'safety-questions.cat-a-mod2.html',
  styleUrls: ['safety-questions.cat-a-mod2.scss'],
})
export class SafetyQuestionsCatAMod2Component implements OnInit {
