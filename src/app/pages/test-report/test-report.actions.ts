...
export const TestReportViewDidEnter = createAction('[TestReportPage] Test Report did enter');
...
export const CalculateTestResult = createAction('[TestResultPage] Calculate Test Result');

export const TerminateTestFromTestReport = createAction('[TestReportPage] Terminate test');

export const ReturnToTest = createAction('[TestReportPage] Return to Test');
