...
//
//       expect(component.localSubscription.unsubscribe)
//         .toHaveBeenCalled();
...
//         .toHaveBeenCalled();
//       expect(component.setupSubscription)
//         .toHaveBeenCalled();
//     });
//   });
//
...
//       spyOn(component, 'translateToQuestionNumberInterface')
//         .and
//         .returnValue(QuestionNumber.ONE);
//       spyOn(cpcQuestionProvider, 'getTotalQuestionScore')
//         .and
//         .returnValue(1);
...
//         .toHaveBeenCalledWith(PopulateQuestionScore(QuestionNumber.ONE, 3));
//       expect(component.store$.dispatch)
//         .toHaveBeenCalledWith(PopulateTestScore(1));
//     });
//   });
//
//   describe('DOM', () => {
...
//       spyOn(store$, 'dispatch');
//       spyOn(cpcQuestionProvider, 'getQuestionScore')
//         .and
//         .returnValue(5);
//       spyOn(cpcQuestionProvider, 'getTotalQuestionScore')
//         .and
...
//         .toHaveBeenCalledWith(AnswerToggled(true, QuestionNumber.ONE, '2'));
//       expect(store$.dispatch)
//         .toHaveBeenCalledWith(PopulateQuestionScore(QuestionNumber.ONE, 5));
//       expect(store$.dispatch)
//         .toHaveBeenCalledWith(PopulateTestScore(40));
//     });
//   });
...
//           lgvQuestion5[0],
//         ]);
//       expect(component.overallPercentage)
//         .toEqual(10);
//       expect(component.category)
//         .toEqual(TestCategory.CCPC);
//     });
//   });
