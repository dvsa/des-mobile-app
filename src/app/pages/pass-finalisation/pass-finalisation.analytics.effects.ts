...
export class PassFinalisationAnalyticsEffects {
  ...
  validationErrorEffect$ = createEffect(() =>
    this.actions$.pipe(
      ...
      switchMap(([action]: [ReturnType<typeof PassFinalisationValidationError>, TestsModel, boolean]) => {
        //GA4 Analytics
  ...
  code78PresentEffect$ = createEffect(() =>
    this.actions$.pipe(
      ...
      concatMap(([,]: [ReturnType<typeof passCompletionActions.Code78Present>, TestsModel, boolean]) => {
        //GA4 Analytics
        this.analytics.logGAEvent(
  ...
  code78NotPresentEffect$ = createEffect(() =>
    this.actions$.pipe(
      ...
      concatMap(([,]: [ReturnType<typeof passCompletionActions.Code78NotPresent>, TestsModel, boolean]) => {
        //GA4 Analytics
        this.analytics.logGAEvent(
          GoogleAnalyticsEvents.CODE78,
          GoogleAnalyticsEventsTitles.TRANSMISSION_TYPE,
