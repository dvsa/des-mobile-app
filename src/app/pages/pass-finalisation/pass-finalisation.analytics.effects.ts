...
export class PassFinalisationAnalyticsEffects {
  private classPrefix = '/PassFinalisation';
  ...
  passFinalisationViewDidEnter$ = createEffect(() =>
    this.actions$.pipe(
      ...
      switchMap(([, tests]: [ReturnType<typeof PassFinalisationViewDidEnter>, TestsModel, boolean]) => {
  ...
  validationErrorEffect$ = createEffect(() =>
    this.actions$.pipe(
      ...
      switchMap(([action, tests]: [ReturnType<typeof PassFinalisationValidationError>, TestsModel, boolean]) => {
        // TODO - MES-9495 - remove old analytics
  ...
  code78PresentEffect$ = createEffect(() =>
    this.actions$.pipe(
      ...
      concatMap(([, tests]: [ReturnType<typeof passCompletionActions.Code78Present>, TestsModel, boolean]) => {
        // TODO - MES-9495 - remove old analytics
  ...
  code78NotPresentEffect$ = createEffect(() =>
    this.actions$.pipe(
      ...
      concatMap(([, tests]: [ReturnType<typeof passCompletionActions.Code78NotPresent>, TestsModel, boolean]) => {
        // TODO - MES-9495 - remove old analytics
        this.analytics.logEvent(
          formatAnalyticsText(AnalyticsEventCategories.POST_TEST, tests),
          formatAnalyticsText(AnalyticsEvents.TOGGLE_CODE_78, tests),
  ...
  provisionalLicenseNotReceived$ = createEffect(() =>
    this.actions$.pipe(
      ...
      concatMap(
        ([, tests]: [ReturnType<typeof passCompletionActions.ProvisionalLicenseNotReceived>, TestsModel, boolean]) => {
          // TODO - MES-9495 - remove old analytics
          this.analytics.logEvent(
            formatAnalyticsText(AnalyticsEventCategories.POST_TEST, tests),
  ...
  provisionalLicenseReceived$ = createEffect(() =>
    this.actions$.pipe(
      ...
      concatMap(
        ([, tests]: [ReturnType<typeof passCompletionActions.ProvisionalLicenseReceived>, TestsModel, boolean]) => {
          // TODO - MES-9495 - remove old analytics
          this.analytics.logEvent(
            formatAnalyticsText(AnalyticsEventCategories.POST_TEST, tests),
            formatAnalyticsText(AnalyticsEvents.TOGGLE_LICENSE_RECEIVED, tests),
  ...
  transmissionChanged$ = createEffect(() =>
    this.actions$.pipe(
  ...
  d255Yes$ = createEffect(() =>
    this.actions$.pipe(
      ...
      concatMap(
        ([, tests, activityCode]: [
          ReturnType<typeof testSummaryActions.D255Yes>,
          TestsModel,
          ActivityCode,
          boolean,
        ]) => {
  ...
  d255No$ = createEffect(() =>
    this.actions$.pipe(
      ...
      concatMap(
        ([, tests, activityCode]: [
          ReturnType<typeof testSummaryActions.D255No>,
          TestsModel,
          ActivityCode,
          boolean,
        ]) => {
  ...
  candidateChoseToProceedWithTestInEnglish$ = createEffect(() =>
    this.actions$.pipe(
      ...
      concatMap(
        ([, tests, activityCode]: [
          ReturnType<typeof commsActions.CandidateChoseToProceedWithTestInEnglish>,
          TestsModel,
          ActivityCode,
          boolean,
        ]) => {
  ...
  candidateChoseToProceedWithTestInWelsh$ = createEffect(() =>
    this.actions$.pipe(
      ...
      concatMap(
        ([, tests, activityCode]: [
          ReturnType<typeof commsActions.CandidateChoseToProceedWithTestInWelsh>,
          TestsModel,
          ActivityCode,
          boolean,
        ]) => {
  ...
  passFinalisationReportActivityCode$ = createEffect(() =>
    this.actions$.pipe(
      ...
      concatMap(
        ([{ activityCode }, tests]: [
          ReturnType<typeof passFinalisationActions.PassFinalisationReportActivityCode>,
          TestsModel,
          boolean,
        ]) => {
  ...
  passFinalisationSeekFurtherDevelopment$ = createEffect(() =>
    this.actions$.pipe(
      ...
      concatMap(
        ([, tests, furtherDevelopment]: [
          ReturnType<typeof SeekFurtherDevelopmentChanged>,
          TestsModel,
          boolean,
          boolean,
        ]) => {
  ...
  passFinalisationReasonGiven$ = createEffect(() =>
    this.actions$.pipe(
      ...
      concatMap(([, tests]: [ReturnType<typeof ReasonForNoAdviceGivenChanged>, TestsModel, string, boolean]) => {
        // TODO - MES-9495 - remove old analytics
        this.analytics.logEvent(
          formatAnalyticsText(AnalyticsEventCategories.POST_TEST, tests),
