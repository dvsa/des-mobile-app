...
import {
  IonicModule, ModalController, NavController, NavParams, Platform, ToastController,
} from '@ionic/angular';
...
describe('OfficeCatBPage', () => {
  ...
  describe('DOM', () => {
    ...
    describe('cropVehicleCheck', () => {
      it('should return passed array if driving faults does not contain' +
      ...
      it('should return passed array if driving faults does contain' +
        ' an element where source is vehicleChecks but serious and dangerous faults do not', () => {
        expect(component.cropVehicleCheck([
          {
            competencyIdentifier: '1',
            source: 'vehicleChecks', comment: '1',
            competencyDisplayName: '1',
            faultCount: 1,
          },
        ],
      ...
      it('should return passed array with all elements with a source of vehicleChecks removed' +
        ' if both driving faults and dangerous faults contain' +
        ' an element where source is vehicleChecks', () => {
        expect(component.cropVehicleCheck([
          { competencyIdentifier: '1', source: '1', comment: '1', competencyDisplayName: '1', faultCount: 1 },
          {
            competencyIdentifier: '2',
            source: 'vehicleChecks',
            comment: '2',
            competencyDisplayName: '2',
            faultCount: 1 },
        ],
        [
          {
      ...
      it('should return passed array with all elements with a source of vehicleChecks removed' +
        ' if both driving faults and serious faults contain' +
        ' an element where source is vehicleChecks', () => {
        expect(component.cropVehicleCheck([
          { competencyIdentifier: '1', source: '1', comment: '1', competencyDisplayName: '1', faultCount: 1 },
          {
