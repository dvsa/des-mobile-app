  ...
  describe('validationErrorEffect', () => {
    it('should call logError with pass with a severity', (done) => {
      ...
      effects.validationErrorEffect$.subscribe((result) => {
        ...
        expect(analyticsProviderMock.logError).toHaveBeenCalledWith(
          `${AnalyticsErrorTypes.VALIDATION_ERROR} (${screenNamePass})`,
    ...
    it('should call logError with fail with a severity', (done) => {
      ...
      effects.validationErrorEffect$.subscribe((result) => {
        ...
        // TODO - MES-9495 - remove old analytics
        expect(analyticsProviderMock.logError).toHaveBeenCalledWith(
          `${AnalyticsErrorTypes.VALIDATION_ERROR} (${screenNameFail})`,
          'faultComment-simple-dangerous-useOfMirrorsSignalling'
        );
        // GA4 Analytics
        expect(analyticsProviderMock.logGAEvent).toHaveBeenCalledWith(
    ...
    it('should call logError with pass, prefixed with practice mode', (done) => {
      ...
      effects.validationErrorEffect$.subscribe((result) => {
        ...
        // TODO - MES-9495 - remove old analytics
        expect(analyticsProviderMock.logError).toHaveBeenCalledWith(
          `${AnalyticsErrorTypes.VALIDATION_ERROR} (${screenNamePracticeModePass})`,
          'faultComment-simple-dangerous-useOfMirrorsSignalling'
        );
        // GA4 Analytics
        expect(analyticsProviderMock.logGAEvent).toHaveBeenCalledWith(
    ...
    it('should call logError with fail, prefixed with practice mode', (done) => {
      ...
      effects.validationErrorEffect$.subscribe((result) => {
        ...
        // TODO - MES-9495 - remove old analytics
        expect(analyticsProviderMock.logError).toHaveBeenCalledWith(
          `${AnalyticsErrorTypes.VALIDATION_ERROR} (${screenNamePracticeModeFail})`,
          'faultComment-simple-dangerous-useOfMirrorsSignalling'
        );
        // GA4 Analytics
        expect(analyticsProviderMock.logGAEvent).toHaveBeenCalledWith(
    ...
    it('should log an event COMPLETE_TEST event when the test with practice mode prefix', (done) => {
      ...
      effects.completeTest$.subscribe((result) => {
        ...
        expect(analyticsProviderMock.logEvent).toHaveBeenCalledWith(
          AnalyticsEventCategories.POST_TEST,
          AnalyticsEvents.CONFIRM_UPLOAD,
          'practice mode - Upload confirmed - Pass'
        );
        expect(analyticsProviderMock.addCustomDimension).toHaveBeenCalledWith(
          AnalyticsDimensionIndices.CANDIDATE_ID,
          '1'
