...
import { AlternateEvidenceProvidedComponent } from '../alternate-evidence-provided.component';

describe('AlternateEvidenceDescriptionComponent', () => {
  let component: AlternateEvidenceProvidedComponent;
  let fixture: ComponentFixture<AlternateEvidenceProvidedComponent>;
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(AlternateEvidenceProvidedComponent);
