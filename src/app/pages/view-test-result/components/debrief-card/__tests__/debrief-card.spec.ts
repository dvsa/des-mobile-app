...
describe('DebriefCardComponent', () => {
  ...
  describe('highwayCode', () => {
    it('should return an array containing an object with ViewTestResultLabels.completed and checked = true'
      ...
      expect(component.highwayCode).toEqual([{ label: ViewTestResultLabels.completed, checked: true }]);
    });
    it('should return an array containing an object with ViewTestResultLabels.notCompleted and checked = false'
      ...
      expect(component.highwayCode).toEqual([{ label: ViewTestResultLabels.notCompleted, checked: false }]);
    });
  });
  describe('controlledStop', () => {
    it('should return an array containing an object with ViewTestResultLabels.completed and checked = true'
      ...
      expect(component.controlledStop).toEqual([{ label: ViewTestResultLabels.completed, checked: true }]);
    });
    it('should return an array containing an object with ViewTestResultLabels.notCompleted and checked = false'
      ...
      expect(component.controlledStop).toEqual([{ label: ViewTestResultLabels.notCompleted, checked: false }]);
    });
  });
  describe('ngOnInit', () => {
  ...
  describe('eco', () => {
    it('should return an array of objects populated with the correct data', () => {
      component.data = { eco: { adviceGivenControl: true, adviceGivenPlanning: true } };
  ...
  describe('getTestRequirementsCatHome', () => {
    it('should return an array of objects populated with the correct data', () => {
      component.data = {
        testRequirements: {
          normalStart1: true, normalStart2: true, angledStart: true, uphillStartDesignatedStart: false,
        },
      };
  ...
  describe('getTestRequirementsCatB', () => {
    it('should return an array of objects populated with the correct data', () => {
      component.data = {
        testRequirements: {
          normalStart1: true, normalStart2: true, angledStart: true, hillStart: false,
        },
      };
  ...
  describe('getTestRequirementsCatADI2', () => {
    it('should return an array of objects populated with the correct data', () => {
      component.data = {
        testRequirements: {
          normalStart1: true, normalStart2: true, angledStart: true, uphillStart: false, downhillStart: false,
        },
      };
