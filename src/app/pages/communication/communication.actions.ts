...
export const CommunicationViewDidEnter = createAction('[CommunicationPage] Communication page did enter');
...
export const NewEmailSelected = createAction('[CommunicationPage] New email selected');

export const PostalSelected = createAction('[CommunicationPage] Post selected');
