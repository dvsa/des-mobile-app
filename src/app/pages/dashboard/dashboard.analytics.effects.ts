...
export class DashboardAnalyticsEffects {
  ...
  practiceTestReportSelected$ = createEffect(() =>
    this.actions$.pipe(
      ...
      switchMap(() => {
        // TODO - MES-9495 - remove old analytics
        this.analytics.logEvent(AnalyticsEventCategories.DASHBOARD, AnalyticsEvents.PRACTICE_TEST_SELECTED);
  ...
  sideMenuOpen$ = createEffect(() =>
    this.actions$.pipe(
      ...
      switchMap(() => {
        // TODO - MES-9495 - remove old analytics
        this.analytics.logEvent(AnalyticsEventCategories.DASHBOARD, AnalyticsEvents.SIDE_MENU, 'Menu Opened');
  ...
  sideMenuClosed$ = createEffect(() =>
    this.actions$.pipe(
      ...
      switchMap(() => {
        // TODO - MES-9495 - remove old analytics
        this.analytics.logEvent(AnalyticsEventCategories.DASHBOARD, AnalyticsEvents.SIDE_MENU, 'Menu Closed');
  ...
  sideMenuItemSelected$ = createEffect(() =>
    this.actions$.pipe(
      ...
      switchMap(([{ item }]) => {
        // TODO - MES-9495 - remove old analytics
        this.analytics.logEvent(AnalyticsEventCategories.DASHBOARD, AnalyticsEvents.SIDE_MENU, `${item} Selected`);
  ...
  updateAvailablePopup$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(() => {
        // TODO - MES-9495 - remove old analytics
        this.analytics.logEvent(AnalyticsEventCategories.APP_UPDATE_BADGE, 'Modal', 'New version modal displayed');
  ...
  updateAvailableOptionClicked$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(([{ selected }]: [ReturnType<typeof UpdateAvailableOptionClicked>, boolean]) => {
        // TODO - MES-9495 - remove old analytics
        this.analytics.logEvent(AnalyticsEventCategories.APP_UPDATE_BADGE, 'Modal', `${selected} button selected`);
  ...
  updateAvailableBadgeClicked$ = createEffect(() =>
    this.actions$.pipe(
      ...
      mergeMap(() => {
        // TODO - MES-9495 - remove old analytics
        this.analytics.logEvent(AnalyticsEventCategories.APP_UPDATE_BADGE, 'New version badge selected');
