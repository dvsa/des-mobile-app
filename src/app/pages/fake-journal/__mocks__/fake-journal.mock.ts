  ...
  },
  {
    booking: {
      ...
      candidate: {
        ...
        driverNumber: 'YOUNG9915220A99HC',
        gender: 'M',
        mobileTelephone: '07677 123456',
        primaryTelephone: '01792 567890',
        secondaryTelephone: '04321 098765',
        dateOfBirth: '1950-02-27',
        ethnicityCode: 'A',
        emailAddress: 'young@soundpraxis.com',
      },
      business: {
        businessAddress: {
          addressLine1: '1 Business Street',
    ...
    slotDetail: {
      duration: 57,
      slotId: `${end2endPracticeSlotId}_17`,
      start: todayAtHour(18).add(42, 'minutes').format(),
    },
    testCentre: {
      centreId: 54321,
      centreName: 'LIVINGSTONE  CENTRE',
      costCode: 'EXTC1',
    },
    vehicleTypeCode: 'B',
    vehicleSlotTypeCode: 3,
    examinerVisiting: false,
  },
];
