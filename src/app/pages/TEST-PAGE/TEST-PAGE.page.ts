...
export class TESTPAGE extends WaitingRoomToCarBasePageComponent implements OnInit {

  pageState: WaitingRoomToCarPageState;
  form: UntypedFormGroup;
  tellMeQuestions: VehicleChecksQuestion[];
  public setStyle: number;
  ...
  activateStyle(number: number) {
    this.setStyle = number;
  }
}
