...
export class VehicleChecksCatDModal {
  ...
  ngOnInit(): void {
    ...
    const { vehicleChecksScore$, safetyQuestionsScore$, vehicleChecks$, fullLicenceHeld$ } = this.pageState;
  ...
  private hasFullLicenceHeldBeenSelected = (fullLicenceHeld: boolean): string =>
