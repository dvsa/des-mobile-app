...
export const TestCentreJournalViewDidEnter = createAction('[TestCentreJournal] Test Centre Journal Did Enter');
...
export const TestCentreJournalSelectExaminer = createAction('[TestCentreJournal] Test Centre Journal select examiner');
