  ...
  describe('journalRefreshError', () => {
    it('should log an error', (done) => {
      ...
      effects.journalRefreshError$.subscribe((result) => {
        expect(result.type === AnalyticRecorded.type).toBe(true);
        expect(analyticsProviderMock.logError).toHaveBeenCalledWith('error-description', 'error-message');
        expect(analyticsProviderMock.logGAEvent).toHaveBeenCalledWith(
          GoogleAnalyticsEvents.JOURNAL,
          GoogleAnalyticsEventsTitles.REFRESH,
    ...
    it('should log an error with AutomaticJournalRefresh', (done) => {
      ...
      effects.journalRefreshError$.subscribe((result) => {
        expect(result.type === AnalyticRecorded.type).toBe(true);
        expect(analyticsProviderMock.logError).toHaveBeenCalledWith('AutomaticJournalRefresh', 'error-message');
        expect(analyticsProviderMock.logGAEvent).toHaveBeenCalledWith(
          GoogleAnalyticsEvents.JOURNAL,
          GoogleAnalyticsEventsTitles.REFRESH,
    ...
    it('should log an error with ManualJournalRefresh', (done) => {
      ...
      effects.journalRefreshError$.subscribe((result) => {
        expect(result.type === AnalyticRecorded.type).toBe(true);
        expect(analyticsProviderMock.logError).toHaveBeenCalledWith('ManualJournalRefresh', 'error-message');
        expect(analyticsProviderMock.logGAEvent).toHaveBeenCalledWith(
          GoogleAnalyticsEvents.JOURNAL,
          GoogleAnalyticsEventsTitles.REFRESH,
