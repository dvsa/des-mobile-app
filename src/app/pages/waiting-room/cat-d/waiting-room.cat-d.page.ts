...
@Component({
  selector: 'app-waiting-room-cat-d',
  templateUrl: './waiting-room.cat-d.page.html',
  styleUrls: ['./waiting-room.cat-d.page.scss'],
})
export class WaitingRoomCatDPage extends WaitingRoomBasePageComponent implements OnInit {
