...
interface CatCPCWaitingRoomPageState {}

type WaitingRoomPageState = CommonWaitingRoomPageState & CatCPCWaitingRoomPageState;
...
export class WaitingRoomCatCPCPage extends WaitingRoomBasePageComponent implements OnInit {
  ...
  async navigateForward(): Promise<void> {
    await this.routeByCat.navigateToPage(TestFlowPageNames.COMMUNICATION_PAGE, TestCategory.CCPC);
  }
}
