...
describe('DrivingFaultsDebriefCardComponent', () => {
  ...
  describe('DOM', () => {
    it('correct driving faults showing', () => {
      ...
      fixture.componentRef.setInput('drivingFaults', drivingFaults);
      fixture.componentRef.setInput('drivingFaultCount', 2);
      fixture.detectChanges();
      ...
      expect(drivingFaultLabels[0].nativeElement.innerHTML.trim()).toBe('Use of speed');
      expect(drivingFaultLabels[1].nativeElement.innerHTML.trim()).toBe('Signals - Timed');
    ...
    it('no driving faults showing', () => {
      fixture.componentRef.setInput('drivingFaults', []);
      fixture.componentRef.setInput('drivingFaultCount', 0);
      fixture.detectChanges();
