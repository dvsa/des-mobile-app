...
export class ExaminerRecordsAnalyticsEffects {
  ...
  examinerStatsViewDidEnter$ = createEffect(() =>
    this.actions$.pipe(
  ...
  colourFilterChanged$ = createEffect(() =>
    this.actions$.pipe(
  ...
  hideChartsChanged$ = createEffect(() =>
    this.actions$.pipe(
  ...
  partialBannerDisplayed$ = createEffect(() =>
    this.actions$.pipe(
