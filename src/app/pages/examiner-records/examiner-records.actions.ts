...
export const ExaminerRecordsViewDidEnter = createAction('[ExaminerRecordsPage] Page Entered');
...
export const LocationChanged = createAction('[ExaminerRecordsPage] Location changed', (location: TestCentre) => ({
  location,
}));
...
export const LoadingExaminerRecords = createAction('[ExaminerRecordsPage] Examiner records begins loading');

export const ReturnToDashboardPressed = createAction('[ExaminerRecordsPage] Return to Dashboard button pressed');

export const DisplayPartialBanner = createAction('[ExaminerRecordsPage] Examiner records partial banner displayed');
