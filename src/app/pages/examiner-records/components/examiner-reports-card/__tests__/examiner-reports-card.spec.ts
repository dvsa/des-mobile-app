...
describe('ExaminerReportsCard', () => {
  ...
  describe('setMinWidth', () => {
    it('should return the portrait width if the card has a chart, ' +
      'it is not a bar chart and isPortrait is true', () => {
    ...
    it('should return the landscape width if the card has a chart, ' +
      'it is not a bar chart and isPortrait is false', () => {
      component.chartTransform = { portrait: { width: 740, height: 300 }, landscape: { width: 1020, height: 300 } };
      component.hasChart = true;
    ...
    it('should return the portrait width multiplied by 1.07 if the card has a chart, ' +
    ...
    it('should return the landscape width multiplied by 1.07 if the card has a chart, ' +
      'it is a bar chart and isPortrait is true', () => {
      component.chartTransform = { portrait: { width: 740, height: 300 }, landscape: { width: 1020, height: 300 } };
      component.hasChart = true;
      component.isPortrait = false;
