...
describe('examiner records selector', () => {
  ...
  describe('getIndependentDrivingStats', () => {
    it(
      'should return an array of all the all instances of Traffic Signs and Sat Nav in the passed tests ' +
    ...
    it(
      'should return an array of all the all instances of Traffic Signs and Diagram in the passed tests ' +
  ...
  describe('getCircuits', () => {
    it(
      'should return an array of all the instances of Left and Right in the passed tests ' +
    ...
    it(
      'should return an empty array if the passed category is not mod 1, ' +
  ...
  describe('getSafetyQuestions', () => {
    it(
      'should return a list of all possible safety questions and the amount of times they appear, ' +
        'ordered by index',
      () => {
        expect(
          getSafetyQuestions(
  ...
  describe('getBalanceQuestions', () => {
    it(
      'should return a list of all possible balance questions and the amount of times they appear, ' +
        'ordered by index',
      () => {
        expect(
          getBalanceQuestions(
  ...
  describe('getShowMeQuestions', () => {
    it(
      'should return a list of all possible show me questions and the amount of times they appear, ' +
        'ordered by index',
      () => {
        expect(
          getShowMeQuestions(
  ...
  describe('getTellMeQuestions', () => {
    it(
      'should return a list of all possible tell me questions and the amount of times they appear, ' +
        'ordered by index',
      () => {
        expect(
          getTellMeQuestions(
  ...
  describe('getManoeuvreTypeLabels', () => {
    it('should return a list of relevant manoeuvre labels for cat B if type is not included', () => {
      expect(getManoeuvreTypeLabels(TestCategory.B)).toEqual({
    ...
    it('should return the string value for the manoeuvre from the list of relevant manoeuvres for the category', () => {
      expect(getManoeuvreTypeLabels(TestCategory.B, ManoeuvreTypes.reverseRight)).toEqual('Reverse right');
    });
    it('should return a list of relevant manoeuvre labels for cat BE if type is not included', () => {
      expect(getManoeuvreTypeLabels(TestCategory.BE)).toEqual({
        reverseLeft: 'Reverse',
      });
    });
    it('should return the string value for the manoeuvre from the list of relevant manoeuvres for the category', () => {
      expect(getManoeuvreTypeLabels(TestCategory.BE, ManoeuvreTypes.reverseLeft)).toEqual('Reverse');
    });
    it('should return a list of relevant manoeuvre labels for cat ADI2 if type is not included', () => {
      expect(getManoeuvreTypeLabels(TestCategory.ADI2)).toEqual({
        reverseRight: 'Reverse right',
        reverseParkRoad: 'Reverse park (road)',
        reverseParkCarpark: 'Reverse park (car park)',
        forwardPark: 'Forward park',
    ...
    it('should return the string value for the manoeuvre from the list of relevant manoeuvres for the category', () => {
      expect(getManoeuvreTypeLabels(TestCategory.ADI2, ManoeuvreTypes.reverseRight)).toEqual('Reverse right');
    });
    it('should return an empty object if an invalid category is passed', () => {
      expect(getManoeuvreTypeLabels(TestCategory.ADI3)).toEqual({});
    });
  });
