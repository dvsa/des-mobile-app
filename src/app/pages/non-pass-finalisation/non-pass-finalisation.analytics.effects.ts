...
export class NonPassFinalisationAnalyticsEffects {
  ...
  nonPassFinalisationViewDidEnterEffect$ = createEffect(() => this.actions$.pipe(
    ...
    switchMap((
      [, tests]:
      [ReturnType <typeof NonPassFinalisationViewDidEnter>, TestsModel],
    ) => {
  ...
  validationErrorEffect$ = createEffect(() => this.actions$.pipe(
    ...
    switchMap((
      [action, tests]:
      [ReturnType <typeof NonPassFinalisationValidationError>, TestsModel],
    ) => {
  ...
  candidateChoseToProccedWithTestInWelsh$ = createEffect(() => this.actions$.pipe(
