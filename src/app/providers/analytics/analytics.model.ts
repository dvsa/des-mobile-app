...
export enum AnalyticsEvents {
  ...
  MOT_EVIDENCE_PROVIDED = 'set mot evidence provided',
  MOT_EVIDENCE = 'set mot evidence',
  ...
  CONFIRM_VRN_MODAL_TRIGGERED = 'confirm VRN modal triggered',
  NO_MOT_DETAILS_FOUND = 'no MOT details found',
  NO_MOT_SERVICE_AVAILABLE = 'no MOT service available',
  MOT_OFFLINE = 'device offline, cannot connect to MOT',
  MOT_BUTTON_PRESSED = 'get MOT button pressed',
