...
export class FaultCountDHelper {
  ...
  public static getVehicleChecksFaultCountCatD = (vehicleChecks: CatDUniqueTypes.VehicleChecks): VehicleChecksScore => {
  ...
  static getVehicleChecksFaultCount = (vehicleChecks: CatDVehicleCheckUnion): VehicleChecksScore => {
  ...
  private static getSeriousFaultSumCountNonTrailer = (
    ...
    const vehicleCheckSeriousFaults = vehicleChecks
      ? FaultCountDHelper.getVehicleChecksFaultCountNonTrailer(vehicleChecks).seriousFaults
      : 0;
  ...
  private static getSeriousFaultSumCountTrailer = (
    ...
    const seriousFaultSumOfSimpleCompetencies = Object.keys(pickBy(seriousFaults)).length;
    const vehicleCheckSeriousFaults = vehicleChecks
      ? FaultCountDHelper.getVehicleChecksFaultCount(vehicleChecks).seriousFaults
      : 0;
