...
} from '../../__mocks__/cat-F-test-data-state-object.mock';
import { catGTestDataStateObject, catGTestDataVCStateObject } from '../../__mocks__/cat-G-test-data-state-object.mock';
...
xdescribe('FaultCountHomeTestHelper', () => {
  ...
  xdescribe('getDrivingFaultSumCountCatHomeTest (Including VehicleChecks)', () => {
    const drivingFaultTests = [
      {
        category: 'F',
        data: catFTestDataVCStateObject,
        expected: 3,
      },
      {
        category: 'G',
        data: catGTestDataVCStateObject,
        expected: 6,
      },
      {
        category: 'H',
        data: catHTestDataVCStateObject,
        expected: 1,
      },
      {
        category: 'K',
        data: catKTestDataVCStateObject,
        expected: 5,
      },
    ];
    drivingFaultTests.forEach((test) => {
