...
import { getTestData as getTestDataCatADI2 } from '@store/tests/test-data/cat-adi-part2/test-data.cat-adi-part2.reducer';
import { getTestData as getTestDataCatAdI3 } from '@store/tests/test-data/cat-adi-part3/test-data.cat-adi-part3.reducer';
...
import { getTestData as getTestDataCatManoeuvre } from '@store/tests/test-data/cat-manoeuvres/test-data.cat-manoeuvres.reducer';
