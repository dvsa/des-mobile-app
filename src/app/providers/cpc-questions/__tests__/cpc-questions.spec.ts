...
describe('CPCQuestionProvider', () => {
  ...
  describe('getCombinations', () => {
    it('should return a list of only LGV codes for CCPC', () => {
      ...
      expect(allCodesLGV)
        .toBe(true);
      expect(shortCodes)
        .toEqual(['LGV1', 'LGV2', 'LGV3', 'LGV4', 'LGV5', 'LGV6', 'LGV7', 'LGV8']);
    });
    it('should return a list of only PCV codes for DCPC', () => {
      ...
      expect(allCodesPCV)
        .toBe(true);
      expect(shortCodes)
        .toEqual(['PCV1', 'PCV2', 'PCV3', 'PCV4', 'PCV5', 'PCV6', 'PCV7', 'PCV8']);
    });
  });
  ...
  describe('getQuestionScore', () => {
    ...
    it('should increment the total question score by 5 for every answer that is true', () => {
      ...
      expect(cpcQuestionProvider.roundToNearestFive)
        .not
        .toHaveBeenCalled();
      expect(score)
        .toEqual(10);
