...
import { Combination, QuestionNumber } from '@shared/constants/cpc-questions/cpc-question-combinations.constants';
...
describe('CPCQuestionProvider', () => {
  ...
  describe('getCombinations', () => {
    it('should return a list of only LGV codes for CCPC', () => {
      ...
      const allCodesLGV = combinations.every((combination: Combination) => combination.code.indexOf('LGV') > -1);
    ...
    it('should return a list of only PCV codes for DCPC', () => {
      ...
      const allCodesPCV = combinations.every((combination: Combination) => combination.code.indexOf('PCV') > -1);
      const shortCodes = combinations.map((combination: Combination) => combination.code);
