export class AuthenticationProviderMock {
  ...
  isInUnAuthenticatedMode = jasmine.createSpy('isInUnAuthenticatedMode')
    .and
    .returnValue(false);
  ...
  getEmployeeId = jasmine.createSpy('getEmployeeId')
    .and
  ...
  setEmployeeId = jasmine.createSpy('setEmployeeId')
    .and
    .returnValue(Promise.resolve());

  expireTokens = jasmine.createSpy('expireTokens')
    .and
    .returnValue(Promise.resolve());

  loadEmployeeName = jasmine.createSpy('loadEmployeeName')
    .and
    .returnValue(Promise.resolve('joe blogs'));
}
