...
export class TestResultProviderMock {
  ...
  calculateTestResultADI3 = jasmine.createSpy('calculateTestResultADI3').and.returnValue(of(ActivityCodes.PASS));
  ...
  calculateCatAdiPart2TestResult = jasmine
    ...
    .and.returnValue(ActivityCodes.PASS);
  ...
  calculateCatHomeTestResult = jasmine.createSpy('calculateCatHomeTestResult').and.returnValue(ActivityCodes.PASS);
