...
export const questions: VehicleChecksQuestion[] = [
  ...
  },
  {
    code: 'H2',
    description:
      'Show me how you would check the brake lights are working on this vehicle, (if you need to switch the ignition on, please dont start the engine).',
  ...
  },
  {
    code: 'H8',
    description:
      'Show me how you would switch your headlight on from dipped to main beam and explain how you would know the beam is on.',
