...
import { CommunicationBasePageComponent } from '../communication-base-page';

describe('CommunicationBasePageComponent', () => {
  let platform: Platform;
  let authenticationProvider: AuthenticationProvider;
  let router: Router;
  let store$: Store<StoreModel>;

  let basePageComponent: CommunicationBasePageComponent;
  const initialState = {
    tests: {
      ...
      startedTests: {
        1234: {
          journalData: {
            candidate: {
              candidateName: { firstName: 'Homer', lastName: 'Simpson' },
            },
          },
  ...
  beforeEach(async(() => {
    ...
    class BasePageClass extends CommunicationBasePageComponent {
      constructor(
  ...
  describe('ngOnInit', () => {
    it('should resolve state variables', () => {
      ...
      basePageComponent.commonPageState.candidateName$
        .subscribe((res) => expect(res).toEqual('Homer Simpson'));
    });
  });
  ...
  describe('ionViewWillEnter', () => {
    it('should set subscription when the merged$ observable is defined', () => {
      ...
      basePageComponent.subscription = {
        ...basePageComponent.subscription,
        closed: true,
      } as Subscription;
